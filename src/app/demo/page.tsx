...
const principleDetails = [
  ...
  { slug: "serverless", icon: Server, title: "Serverless by Design (Done Schematically)", subtitle: "No central infrastructure. No single point of failure.", description: "kryosette has no servers. Not a single one. The entire network runs on peer‑to‑peer communication with distributed hash tables for discovery. There is nothing to hack, nothing to subpoena, nothing to shut down." },
