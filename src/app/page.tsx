          ...
          >
              ...
              <div className="bg-gray-50 p-8 rounded-3xl">
                ...
                <ul className="space-y-3 text-gray-600">
                  <li className="flex items-start gap-3">
                    ...
                    <span>User profile system</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-gray-400 mt-1">—</span>
                    <span>Friend adding mechanism</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-gray-400 mt-1">—</span>
                    <span>Posts with comments & polls</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-gray-400 mt-1">—</span>
                    <span>Public / private chats</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-gray-400 mt-1">—</span>
                    <span>Transcendent bridge (prototype)</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-gray-400 mt-1">—</span>
                    <span>Security scanners & detectors</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-gray-400 mt-1">—</span>
                    <span>Proprietary onion routing</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-gray-400 mt-1">—</span>
                    <span>In‑memory DB (base)</span>
                  </li>
                </ul>
              </div>
              <div className="bg-gray-50 p-8 rounded-3xl">
                ...
                <ul className="space-y-3 text-gray-600">
                  <li className="flex items-start gap-3">
                    <span className="text-gray-400 mt-1">—</span>
                    <span>RPKI validator</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-gray-400 mt-1">—</span>
                    <span>Additional network security tools</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-gray-400 mt-1">—</span>
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-gray-400 mt-1">—</span>
                    <span>Replication & more</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-gray-400 mt-1">—</span>
                    <span>Local truth‑engine analyzer</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-gray-400 mt-1">—</span>
                    <span>Advanced DPI bypass</span>
                  </li>
                </ul>
              </div>
            </div>
            <div className="mt-12 text-center">
              <p className="text-xl text-gray-600">
                ...
                <span className="font-bold text-black">May 17–18, 2026</span>
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="text-center px-4">
          ...
          >
            <Link
              href="/self-university"
              className="group inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-white bg-black rounded-full hover:bg-gray-800 transition-all hover:scale-105"
            >
...
function TechSection({ 
  ...
  return (
    <section className="relative min-h-screen flex items-center py-20 overflow-hidden">
        ...
        <div className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-16 lg:gap-24`}>
            ...
            <div className="space-y-6">
              ...
              >
                <Link
                  ...
                  className="inline-flex items-center text-white/50 hover:text-white transition-colors group text-lg"
                >
                  Learn more
                  <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
                </Link>
          ...
          >
            <div className="relative">
              <div className="text-[20vw] font-extrabold text-white/5 select-none leading-none">
      ...
      <motion.div className="absolute bottom-0 left-0 right-0 h-px bg-white/10">
        <motion.div 
