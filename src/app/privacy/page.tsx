      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-invert max-w-none text-white/70 space-y-6">
          ...
          <section>
            ...
            <p>
              <strong className="text-white">We do not collect personal information.</strong> The Application is designed to
          ...
          <section>
            ...
            <p>
              <strong className="text-white">We do not use cookies, analytics trackers, or any other monitoring
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">5. Data Sharing and Disclosure</h2>
            <p>
              <strong className="text-white">We do not share your data with third parties.</strong> Since your data is stored
