    ...
    <div className="min-h-screen bg-white pt-11">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-neutral max-w-none text-black/75 space-y-6">
          ...
          <section>
            <h2 className="text-xl font-semibold text-black">3. User Content and Responsibilities</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-black">4. Prohibited Conduct</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-black">5. Disclaimer of Warranties</h2>
            <p>
