...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 z-50 w-full bg-white/80 backdrop-blur-md border-b border-gray-200/50">
        ...
        <ul className="hidden md:flex items-center space-x-7 text-sm font-medium text-gray-800">
          ...
          <li>
            ...
            >
              Technologies
              <ChevronDown
                className={`w-4 h-4 transition-transform duration-200 ${isTechDropdownOpen ? "rotate-180" : ""
                  }`}
              />
            </button>
          </li>
      ...
      <div
        ref={dropdownRef}
        className={`absolute left-0 right-0 top-12 bg-white/95 backdrop-blur-md border-b border-gray-200/50 shadow-lg transition-all duration-300 ease-out ${isTechDropdownOpen
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden fixed inset-0 top-12 bg-white/95 backdrop-blur-md transition-all duration-300 ease-out ${isMobileMenuOpen
